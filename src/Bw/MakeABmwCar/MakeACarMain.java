        ...
        do {
            ...
            if (area >= 1 && area <= 4 && nop > 0 && nop < 100 && carType >= 1 && carType <= 3 && add_Ons >= 1 && add_Ons <= 2 && weather >= 1 && weather <= 3) {
                if (carType == 1) {
                    ...
                    System.out.println("총 비용 : " + df.format (bmwXSportsCar.totalPrice(nop, area, add_Ons)) + "원");
                ...
                if (carType == 2) {
                    ...
                    System.out.println("총 비용 : " + df.format (bmwXPassengerCar.totalPrice(nop, area, add_Ons)) + "원");
                ...
                if (carType == 3) {
                    ...
                    System.out.println("총 비용 : " + df.format (bmwXBus.totalPrice(nop, area, add_Ons)) + "원");
