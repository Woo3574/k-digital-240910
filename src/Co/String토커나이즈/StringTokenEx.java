...
public class StringTokenEx {
    public static void main(String[] args) {
        tokenFunc(); // 스트링 토커나이즈를 이용한 방식 (옜날 방식)
        splitFunc(); // 문자열의 split() 메서드를 이용하는 방식
        classFunc();
    }
    ...
    static void tokenFunc() {
        ...
        StringTokenizer st = new StringTokenizer(name, "/"); // 구분자 delim
    ...
    static void splitFunc() {
        ...
        System.out.print("이름을 / 기준으로 입력 하세요 : ");
        String name = sc.nextLine();
        String[] nameSub = name.split("[/,;]"); // 정규표현식의 약자 regex
        System.out.println(Arrays.toString(nameSub));
    }
