...
public class IPadPro {
    ...
    private Scanner sc; // 입력을 받기 위한 스캐너 참조 변수 생성
    ...
    public void setColor() {
        while (true) {
            ...
            System.out.println("색상 선택이 잘 못 되었습니다.");
        }
    }
    public void setMemory() {
        while (true) {
            System.out.print("Memory 용량 선택 [1]256GB [2]512GB [3]1TB [4]2TB : ");
            memory = sc.nextInt();
            if (memory > 0 && memory < 5) return;
            System.out.println("Memory 용량 선택이 잘 못 되었습니다.");
        }
    }
    public void setNetwork() {
        while (true) {
            ...
            System.out.println("Network 선택이 잘 못 되었습니다.");
        }
    }
    public void setName() {
    ...
    public void iPadProInfo() {
        ...
        System.out.println("제품가격 : " + iPadProCalcPrice() + "원");
        System.out.println("=============================================");
    }
